...
<body>
    ...
    <div class="section">
            <div class="top_navbar">
                ...
                <div class="das">KETERLAMBATAN
                </div><br>
                <div>
                    <h1 id="kuat">KUAT MA'RIFAT</h1></div>
            </div>
        <div class="sidebar">
    ...
    <div class="wrapper">
        ...
        <input type="text" id="kelas" name="kelas" required value="<?=@$p_piket['kelas']?>">
        
        <label for="tanggal">Tanggal:</label> 
        <input type="date" id="tanggal" name="tanggal" required <?=@$p_piket['tanggal']?>>
        ...
        <input type="text" name="keterangan" required value="<?=@$p_piket['keterangan']?>"></input><br><br><br>
